...
public class DbInitializer
{
    ...
    public DbInitializer(IDbContextFactory<AppDbContext> factory)
    {
        _factory = factory;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        if (!await db.Tags.AnyAsync())
        {
            string[] prebuilt =
            {
                ...
                "Birthday","Holiday","Vacation","Celebration","Exercise","Reading","Writing",
                "Cooking","Meditation","Yoga","Music","Shopping","Parenting","Projects","Planning","Reflection"
            };
